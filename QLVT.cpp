	...
	while(1)
	{
		...
		else if (c == BACKSPACE)
		{
			...
			else
			{
				...
				cout << c << " " << c;// de khoang trang len cho can xoa
				x[i] = NULL;
				continue;
			}
		}
		...
		else
		{
			...
			{
				ThongBao("Chuoi chi chua chu hoac so. Xin kiem tra lai!", 9, 5);//BaoLoi("Chuoi chi chua chu hoac so. Xin kiem tra lai!");
				continue;			
			}
		}
